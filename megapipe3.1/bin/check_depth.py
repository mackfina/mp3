...
if(gencovprop < 0.95): # The threshold is 95%
    ...
    # CHANGE OUTPUT DIRECTORY HERE IF CHANGEING IT ELSEWHERE !!!
    with open("/n/data1/hms/dbmi/farhat/rollingDB/MIC-ML_output/Wadsworth/{0}/depth/{0}_depth_OK".format(tag),"w") as outf:
        outf.write("OK\n")
